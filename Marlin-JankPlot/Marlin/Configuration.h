...
#define STRING_CONFIG_H_AUTHOR "Dave & Ed" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Jank BETA"// will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "https://ejg.io"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "JANK Plotter"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "47789a0c-ac17-40b6-b2b7-3858b353c1a9"
